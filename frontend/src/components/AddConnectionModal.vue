          ...
          <div class="form-section advanced-section">
            ...
            <div v-if="showAdvanced" class="advanced-content">
              <div class="form-section">
                ...
                <select v-model="form.connectionType" class="form-input">
                  <option value="direct">Direct Connection (1st Degree)</option>
                  <option value="through">
                    Connected Through Someone Else
                  </option>
                </select>
                <p class="form-hint">
                  {{
              ...
              <div
                ...
                class="form-section"
              >
                <label class="form-label"> Connected Through * </label>
                ...
                <p class="form-hint">
                  Search for the person who connects you to this new connection.
                </p>
              </div>
            </div>
          </div>
  ...
  try {
    ...
    if (!created || !("node" in created)) {
      const errorMsg = String(
        (created as any)?.error || "createNodeForUser failed"
      );
      console.error(
        "[AddConnection] createNodeForUser failed:",
        errorMsg,
        created
      );
    ...
    if (form.value.connectionType === "direct") {
      ...
      console.log(
        "[AddConnection] Creating direct edge from",
        auth.userId,
        "to",
        nodeId
      );
