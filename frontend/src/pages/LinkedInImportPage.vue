            ...
            <div class="file-upload-section">
                ...
                <div v-if="selectedFile" class="file-info">
                    <p>
                        ...
                        <strong>Size:</strong>
                        {{ formatFileSize(selectedFile.size) }}<br />
            ...
            <div class="info-grid">
                ...
                <div>
                    ...
                    <p class="muted">
                        ...
                        lastName, headline, etc. The system will automatically
                        map your fields using AI.
                    </p>
                </div>
            </div>
        </section>
...
import type { LinkedInConnection } from "@/services/conceptClient";
