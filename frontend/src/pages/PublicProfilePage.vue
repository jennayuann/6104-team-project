    ...
    <div class="profile-page">
        <section class="profile-actions card">
            ...
            <div
                ...
                "
            >
                <strong>Note:</strong> Public profile updates (photo, headline,
                links) are currently unstable. We're working on fixes.
            </div>
        ...
        <section class="profile-main card">
            ...
            <div
                v-if="uniqueConnectionResults.length"
                class="connection-results"
            >
                <article
                    v-for="result in uniqueConnectionResults.filter(
                        (r) => r.connection
                    )"
